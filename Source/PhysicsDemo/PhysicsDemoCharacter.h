...
#include "PhysicsDemoCharacter.generated.h"
...
UCLASS(config=Game)
class APhysicsDemoCharacter : public ACharacter
{
	GENERATED_BODY()
	...
	/** Grabbed Objects will snap to this */
...
public:
	...
	TSubclassOf<class APhysicsDemoProjectile> ProjectileClass;
...
protected:
	...
	void SetToGravityWeapon();

	void SetToShotWeapon();
